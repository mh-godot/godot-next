...
func _enter_tree():
	...
	add_custom_type("ControlSwitcher", "BaseSwitcher", preload("res://addons/godot-next/gui/navigation/ControlSwitcher/ControlSwitcher.gd"), preload("res://addons/godot-next/gui/navigation/ControlSwitcher/icon_control_switcher.png"))
